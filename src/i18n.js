const en = {
  ...
  recovered: 'recovered',
  unavailable: 'Remote Control not available here (login/plan)',
  gaveUp: 'gave up after repeated re-arms — reconnect once by hand',
  rearmed: 're-armed',
...
const ja = {
  ...
  recovered: '自力で復帰',
  unavailable: 'この環境ではリモートコントロール不可(ログイン/プラン)',
  gaveUp: '再接続が効かないため打ち切り(手動で一度 /remote-control を)',
  rearmed: '繋ぎ直しました',
